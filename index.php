                ...
                <div class="card h-100 border-0 shadow-sm d-flex flex-column">
                    ...
                    <div class="card-body text-start flex-grow-1">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-outline-dark add-to-cart d-flex align-items-center" type="button" data-id="<?= htmlspecialchars($datos->product_id) ?>" data-name="<?= htmlspecialchars($datos->product_name) ?>" data-price="<?= htmlspecialchars($datos->product_price) ?>" data-image="<?= htmlspecialchars($datos->product_image) ?>">
